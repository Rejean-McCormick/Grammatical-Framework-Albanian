...
concrete ExtendSqi of Extend =
  ...
  lin
    ...
    ComplBareVS = ComplVS ;
    ComplDirectVS x1 x2 = lin VP (sc_ComplDirectVS (lin VS x1) (lin Utt x2)) ;
    ComplDirectVQ x1 x2 = lin VP (sc_ComplDirectVQ (lin VQ x1) (lin Utt x2)) ;
    ...
    ComplGenVV x1 x2 x3 x4 = lin VP (sc_ComplGenVV (lin VV x1) (lin Ant x2) (lin Pol x3) (lin VP x4)) ;
    ...
    ComplSlashPartLast x1 x2 = lin VP (sc_ComplSlashPartLast (lin VPSlash x1) (lin NP x2)) ;
    ...
    A2VPSlash x1 = lin VPSlash (vp_A2VPSlash (lin A2 x1)) ;
    N2VPSlash x1 = lin VPSlash (vp_N2VPSlash (lin N2 x1)) ;
    ...
    AdvRVP x1 x2 x3 = lin VP (rnp_AdvRVP (lin VP x1) (lin Prep x2) (lin RNP x3)) ;
