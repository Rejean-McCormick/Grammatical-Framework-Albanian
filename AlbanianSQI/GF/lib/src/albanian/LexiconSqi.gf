...
concrete LexiconSqi of Lexicon = CatSqi **
  ...
  lin
    ...
    animal_N                 = mkN "kafshë" ;
    answer_V2S               = mkV2S (mkV "përgjigjem") (mkPrep [] dative) noPrep "se" ;
    ...
    beer_N                   = mkN "birrë" ;
    beg_V2V                  = mkV2V (mkV "lutem") (mkPrep [] dative) noPrep ;
    belly_N                  = mkN "bark" ;
    big_A                    = mkA "madh" ;
    ...
    broad_A                  = mkA "gjerë" ;
    brother_N2               = mkN2 (mkN "vëlla") genitivePrep ;
    brown_A                  = mkA "kafe" ;
    burn_V                   = mkV "digjem" ;
    butter_N                 = mkN "gjalpë" ;
    ...
    fall_V                   = mkV "rrëzohem" ;
    far_Adv                  = mkAdv "larg" ;
    father_N2                = mkN2 (mkN "baba") genitivePrep ;
    fat_N                    = mkN "dhjamë" ;
    fear_VS                  = mkVS (mkV "druaj") "se" ;
    ...
    milk_N                   = mkN "qumësht" ;
    moon_N                   = mkN "hënë" ;
    mother_N2                = mkN2 (mkN "nënë") genitivePrep ;
    mountain_N               = mkN "mal" ;
    mouth_N                  = mkN "gojë" ;
    music_N                  = mkN "muzikë" ;
    name_N                   = mkN "emër" ;
  ...
  oper
    genitivePrep : Prep = lin Prep R.mkGenitiveCompl ;

    mkPrepLex : Str -> R.Case -> Prep = \s,c ->
      lin Prep {s = s ; c = c ; kind = R.OrdinaryCompl} ;
