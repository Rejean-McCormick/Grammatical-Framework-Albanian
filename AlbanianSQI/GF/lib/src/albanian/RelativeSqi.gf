...
lin
  ...
  RelSlash rp cl = {
    s = \\agr,t,ant,pol =>
      cl.c2.s ++ rp.s ! cl.c2.c ! agr.gn ++ cl.s ! t ! ant ! pol ++ cl.gapPost ! agr
  } ;

  -- Fully inflected cili strategy.  Ordinary RelCl remains invariant që;
  -- this RP path is used when the common RGL requires an overt case-bearing RP.
