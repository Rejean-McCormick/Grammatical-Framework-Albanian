...
oper
  ...
  they_Pron =
    ResSqi.mkPron "ata" "ata" "atyre" "atyre" "i" "u" (GPl Masc) P3 ;

  we_Pron =
    ResSqi.mkPron "ne" "ne" "neve" "nesh" "na" "na" (GPl Masc) P1 ;

  whatPl_IP = lin IP {
    s=table {Nom=>"çfarë"; Acc=>"çfarë"; Dat=>"çfarë"; Gen=>"çfarë"; Ablat=>"çfarë"};
    a={gn=GPl Masc;p=P3}
  } ;
  whatSg_IP = lin IP {
    s=table {Nom=>"çfarë"; Acc=>"çfarë"; Dat=>"çfarë"; Gen=>"çfarë"; Ablat=>"çfarë"};
  ...
  whoPl_IP = lin IP {
    s=table {Nom=>"kush"; Acc=>"kë"; Dat=>"kujt"; Gen=>"kujt"; Ablat=>"kujt"};
    a={gn=GPl Masc;p=P3}
  } ;
  whoSg_IP = lin IP {
    s=table {Nom=>"kush"; Acc=>"kë"; Dat=>"kujt"; Gen=>"kujt"; Ablat=>"kujt"};
  ...
  youPl_Pron =
    ResSqi.mkPron "ju" "ju" "juve" "jush" "ju" "ju" (GPl Masc) P2 ;
