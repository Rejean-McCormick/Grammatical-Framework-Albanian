...
concrete VerbSqi of Verb = CatSqi **
  ...
  oper
    ...
    slashToVP : VPSlash -> VP = \sl -> lin VP {
      ...
      perfectAux = selectPerfectAux sl.morphVoice sl.perfectAux ;
      cl = sl.cl ;
      subjcl = sl.subjcl ;
      post = sl.post
    } ;
  ...
  lin
    ...
    SlashVV vv sl = lin VPSlash {
      ...
      perfectAux = selectPerfectAux vv.morphVoice vv.perfectAux ;
      cl = [] ;
      subjcl = "të" ;
    ...
    SlashV2VNP v2v np sl = lin VPSlash {
      ...
      perfectAux = selectPerfectAux v2v.morphVoice v2v.perfectAux ;
      cl = [] ;
      subjcl = "të" ;
    ...
    VPSlashPrep vp prep = lin VPSlash {
      ...
      perfectAux = selectPerfectAux vp.morphVoice vp.perfectAux ;
      cl = vp.cl ;
      subjcl = vp.subjcl ;
      post = vp.post ;
      c2 = prep
