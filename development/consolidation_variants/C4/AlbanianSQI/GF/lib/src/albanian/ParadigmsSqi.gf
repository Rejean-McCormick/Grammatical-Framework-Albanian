...
irregVFull :
  (pres,perfect,aor,imperf,subj,presOpt,perfOpt,presAdm,imperfAdm : Number => Person => Str) ->
  (imp : Number => Str) -> Str -> V =
  \pres,perfect,aor,imperf,subj,presOpt,perfOpt,presAdm,imperfAdm,imp,part -> lin V {
...
-- Exact non-active counterpart of irregVFull.  This constructor is used only
-- when the supplied tables themselves are non-active; it never derives a
-- non-active paradigm from active surface strings.
irregVFullNA :
  (pres,perfect,aor,imperf,subj,presOpt,perfOpt,presAdm,imperfAdm : Number => Person => Str) ->
  (imp : Number => Str) -> Str -> V =
  \pres,perfect,aor,imperf,subj,presOpt,perfOpt,presAdm,imperfAdm,imp,part -> lin V {
