...
lin InflectionN, InflectionN2, InflectionN3 = \x -> {
      ...
      s2=frameTable (
           ...
           tr (intagAttr "th" "rowspan=\"4\"" "Indef" ++ th "Nom" ++ td (nounForm x Indef Nom Sg) ++ td (nounForm x Indef Nom Pl)) ++
           ...
           tr (intagAttr "th" "rowspan=\"4\"" "Def" ++ th "Nom" ++ td (nounForm x Def Nom Sg) ++ td (nounForm x Def Nom Pl)) ++
      ...
      s3=[]
        ...
        y : Case => Gender => Number => Str =
          \\c,g,n => case x.clit of {
                       True  => link_clitic ! Indef ! c ! g ! n ++ adjForm x c g n ;
                       False => adjForm x c g n
                     } ;
    } ;
