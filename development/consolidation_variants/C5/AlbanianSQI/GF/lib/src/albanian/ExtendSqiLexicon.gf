...
oper
  ...
  lex_iFem_Pron : Pron =
    mkPronConst "unë" "mua" "mua" R.Fem Sg ;
  lex_youFem_Pron : Pron =
    mkPronConst "ti" "ty" "ty" R.Fem Sg ;
  lex_weFem_Pron : Pron =
    mkPronConst "ne" "ne" "neve" R.Fem Pl ;
  lex_youPlFem_Pron : Pron =
    mkPronConst "ju" "ju" "juve" R.Fem Pl ;
  ...
  lex_youPolPl_Pron : Pron =
    mkPronConst "ju" "ju" "juve" R.Masc Pl ;
  lex_youPolPlFem_Pron : Pron =
    mkPronConst "ju" "ju" "juve" R.Fem Pl ;

  lex_dapAsNP : R.Gender -> DAP -> NP = \g,dap -> lin NP {
    s=\\c =>dap.s!c!g ; a=R.agrgP3 g dap.n ; isPron=False
  } ;
