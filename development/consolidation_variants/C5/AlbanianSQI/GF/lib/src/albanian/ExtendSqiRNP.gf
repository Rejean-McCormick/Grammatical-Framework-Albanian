...
oper
  ...
  rnp_ReflRNP : R.VPSlash -> RNPRec -> R.VP = \sl,rnp -> case rnp.isPron of {
    True => appendReflClitic (vpFromSlash sl) ;
  ...
  rnp_ReflPoss : Num -> CN -> RNPRec = \num,cn -> {
    s=\\a,c =>R.nounForm cn R.Def c num.n ++ case a.p of {
  ...
  rnp_PossPronRNP : Pron -> Num -> CN -> RNPRec -> NP = \pron,num,cn,r -> lin NP {
    s=\\c =>R.nounForm cn R.Def c num.n ++ R.nyje!R.Def!c!cn.g!num.n ++
      r.s!pron.a!R.Gen ; a=R.agrgP3 cn.g num.n ; isPron=False
  } ;
