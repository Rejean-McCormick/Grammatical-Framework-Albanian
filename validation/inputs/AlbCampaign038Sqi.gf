concrete AlbCampaign038Sqi of AlbCampaign038 =
  ...
  lincat Probe = {s : Str} ;
  lin
    C0371 = {s = (S.mkS (S.mkCl S.i_NP (P.mkVV "dua") (S.mkVP L.come_V))).s} ;
    C0372 = {s = (S.mkS (S.mkCl S.i_NP (P.mkVV "dua") (S.mkVP L.read_V2 (S.mkNP S.theSg_Det L.book_N)))).s} ;
    C0373 = {s = (S.mkS (S.mkCl S.he_NP (P.mkVV "dua") (S.mkVP L.live_V))).s} ;
    C0374 = {s = (S.mkS S.negativePol (S.mkCl S.i_NP (P.mkVV "dua") (S.mkVP L.come_V))).s} ;
    C0375 = {s = (S.mkS S.pastTense (S.mkCl S.i_NP (P.mkVV "dua") (S.mkVP L.come_V))).s} ;
